...
class _DeliveryContainerWidgetState extends State<DeliveryContainerWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        buildRadioContainer(
          address: ' Jln.Manunggal 2, RT.15/RW002, Jakarta Selatan',
          name: authController.capitalize(authController.displayUserName.value),
          phone: '087788724288',
          title: 'Rumah',
          value: 1,
        ...
        Obx(
          () => buildRadioContainer(
            address: "Jl. Ciledug Raya, RT.10/RW.2,Jakarta Selatan",
            name:
